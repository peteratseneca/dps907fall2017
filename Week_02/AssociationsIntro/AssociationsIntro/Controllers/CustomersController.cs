...
namespace AssociationsIntro.Controllers
{
    public class CustomersController : ApiController
    {
        ...
        // Attention 36 - Return types are IHttpActionResult for all except the Delete() method, which  void
        ...
        // Attention 37 - Get one, with associated object, use attribute routing

        // GET: api/Customers/5/WithEmployee
        [Route("api/customers/{id}/withemployee")]
        public IHttpActionResult GetWithEmpoloyee(int? id)
        {
            // Attempt to fetch the object
